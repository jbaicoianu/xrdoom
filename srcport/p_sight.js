...
//
export function P_DivlineSide ( x, y, node )
{
    var dx,
        dy,
        left,
...
//
export function P_InterceptVector2 ( v2, v1 )
{
    var frac,
        num,
        den;
...
//
export function P_CrossSubsector (num)
{
    var seg,
        line,
        s1,
...
//
export function P_CrossBSPNode (bspnum)
{
    var bsp,
        side;
